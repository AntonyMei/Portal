...
public class ConnectionController : MonoBehaviour
{
    ...
    [Header("Ray Settings")]
    [Tooltip("The material attached to non-active rays")]
    public Material NonactiveRayMaterial;
    [Tooltip("The material attached to active rays")]
    ...
    void Update() {
        ...
        if (Input.GetKeyDown(KeyCode.Mouse1)) {
            if (!is_first_anchor_set) {
                ...
                if (hit_info.distance != 0 && hit_info.transform.tag == "Anchor") {
                    if (hit_info.transform != first_anchor.transform) {
                        ...
                        if (!second_anchor_script.RayList.Contains(ray_id_1)
                            ...
                            ray_renderer.SetRenderer(NonactiveRayMaterial, RayMesh);
